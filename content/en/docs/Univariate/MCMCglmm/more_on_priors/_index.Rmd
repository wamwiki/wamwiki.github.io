...
```{r model1.7, message=FALSE, results='hide', cache=TRUE}
prior1.7 <- list(
...
```{r model1.8, message=FALSE, results='hide', cache=TRUE}
prior1.8 <- list(
...
```{r model1.9, message=FALSE, results='hide', cache=TRUE}
prior1.9 <- list(
...
```{r model2, message=FALSE, results='hide', cache=TRUE}
prior2.0 <- list(
  G = list(G1 = list(V = 1, nu = 0.002),
           G2 = list(V = 1, nu = 0.002),
           G3 = list(V = 1, nu = 0.002),
...
```{r model2.1, message=FALSE, results='hide', cache=TRUE}
prior2.1 <- list(
...
```{r model1.7FEprior, message=FALSE, results='hide', cache=TRUE}
prior1.7FEprio <- list(
  B = list(mu=c(0, -3, 0), V=VpriorB),
  G = list(G1 = list(V = 1, nu = 1, alpha.V=1000),
           G2 = list(V = 1, nu = 1, alpha.V=1000),
